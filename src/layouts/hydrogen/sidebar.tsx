...
export default function Sidebar({ className }: { className?: string }) {
  ...
  return (
    ...
    >
      <div className="sticky top-0 z-40 bg-gray-0/10 px-6 pb-5 pt-5 dark:bg-gray-100/5 2xl:px-8 2xl:pt-6 items-center flex flex-col">
        <Link href={'/'} aria-label="Site Logo"  className="mb-6 flex flex-col items-center max-w-[168px] xl:mb-8 justify-center">
                <Image  src={logoImg} alt="SmartParking"  className="justify-center"/>
                <Image
                  src={logoImgText}
                  alt="SmartParking Text"
