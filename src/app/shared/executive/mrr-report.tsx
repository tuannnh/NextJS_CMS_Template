...
export default function MRRReport({ className }: { className?: string }) {
  return (
    ...
    >
          ...
          >
            <defs>
              ...
              >
                ...
                <stop offset="1" stopColor="#FF1A1A" stopOpacity="0" /> */}
      ...
      <div className="  ">
        <div className="mb-4 flex items-center justify-between border-b border-gray-200 pb-4 font-medium last:mb-0 last:border-0 last:pb-0">
